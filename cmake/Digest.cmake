# digest builtin (md5sum, sha1sum, ...): wraps th-blitz/Hash-Algorithms, cloned
# into third_party/ on first configure. Included when BUILTIN_DIGEST is ON
# (-DBUILTIN_DIGEST=ON, or -DENABLE_ALL_BUILTINS=ON).
...
if(NOT EXISTS "${HASH_ALGORITHMS_DIR}/md5.c")
  ...
  foreach(
    GIT_ARGS
    "init|--quiet" "remote|add|origin|${HASH_ALGORITHMS_REPO}"
    "fetch|--quiet|--depth|1|origin|${HASH_ALGORITHMS_REV}"
...
foreach(ALGO md5 sha1 sha224 sha256 sha384 sha512-224 sha512-256 sha512)
  append_unique(HASH_ALGORITHMS_SOURCES "third_party/Hash-Algorithms/${ALGO}.c")
endforeach()
...
append_unique(BUILTIN_SOURCES ${HASH_ALGORITHMS_SOURCES})
