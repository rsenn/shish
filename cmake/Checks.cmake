...
macro(check_source_definitions)
  ...
  foreach(TYPE ${SOURCE_TYPES})
    add_list(SOURCE_DEFINITIONS -D_${TYPE}_SOURCE)
  endforeach()
...
function(check_alloca)
  ...
  set(CMAKE_REQUIRED_QUIET TRUE)
  if(HAVE_ALLOCA_H)
    add_list(CMAKE_REQUIRED_INCLUDES alloca.h)
...
macro(check_memory_mapping)
  ...
  if(HAVE_SYS_MMAN_H)
    ...
    add_list(CMAKE_REQUIRED_INCLUDES sys/mman.h)
  endif()
