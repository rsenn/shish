...
DEFINES += HAVE_ALLOCA=1 HAVE_FCNTL=1 HAVE_GETHOSTNAME=1 HAVE_GLOB=1 HAVE_GLOBFREE=1 HAVE_ISSETUGID=1 HAVE_LSTAT=1 HAVE_POLL=1 HAVE_READLINK=1 HAVE_SELECT=1 HAVE_SETHOSTNAME=1 HAVE_SIGSET_T=1 HAVE_SSIZE_T=1 HAVE_SYS_SIGLIST=1 HAVE_TERMIOS=1 HAVE_UID_T=1
