...
int builtin_awk(int argc, char* argv[]);
...
int builtin_link(int argc, char* argv[]);
...
int builtin_readlink(int argc, char* argv[]);
int builtin_readonly(int argc, char* argv[]);
int builtin_realpath(int argc, char* argv[]);
...
int builtin_timeout(int argc, char* argv[]);
...
extern const char help_timeout[];
extern const char help_touch[];
