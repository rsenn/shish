...
/* Error codes */
#define GLOB_NOSPACE                                                                                                                                           \
  (1) /**< (Error result code:) An attempt to allocate memory failed, or if errno                                                                              \
         was 0 GLOB_LIMIT was specified in the flags and ARG_MAX patterns were                                                                                 \
         matched. */
#define GLOB_ABORTED                                                                                                                                           \
...
#define GLOB_NOMATCH                                                                                                                                           \
  (3)                           /**< (Error result code:) The pattern does not match any existing pathname,                                                    \
                                   and GLOB_NOCHECK was not set int flags. */
...
#define GLOB_APPEND                                                                                                                                            \
  0x00000020 /**< Append to results of a previous call. Not currently supported in                                                                             \
                this implementation. */
#define GLOB_NOESCAPE                                                                                                                                          \
  0x00000040 /**< Backslashes don't quote metacharacters. Has no effect in this                                                                                \
                implementation, since escaping is not supported. */
...
#define GLOB_MAGCHAR                                                                                                                                           \
  0x00000100                             /**< Set in gl_flags if any metachars seen. Supported from                                                            \
                                            version 1.6 of UNIXEm. */
/* #define GLOB_ALTDIRFUNC 0x00000200 */ /**< Use gl_opendir et al functions. Not
...
#define GLOB_NOMAGIC                                                                                                                                           \
  0x00000800 /**< If no magic chars, return the pattern. Supported from                                                                                        \
                version 1.6 of UNIXEm. */
#define GLOB_TILDE                                                                                                                                             \
  0x00001000 /**< Expand ~user and ~ to home directories. Partially supported from                                                                             \
                version 1.6 of UNIXEm: leading ~ is expanded to                                                                                                \
                %HOMEDRIVE%%HOMEPATH%. */
#define GLOB_ONLYDIR                                                                                                                                           \
  0x00002000 /**< Match only directories. This implementation guarantees to only                                                                               \
                return directories when this flag is specified. */
#define GLOB_TILDE_CHECK                                                                                                                                       \
  0x00004000                     /**< Like GLOB_TILDE but return an GLOB_NOMATCH even if GLOB_NOCHECK                                                          \
                                    specified. Supported from version 1.6 of UNIXEm. */
#define GLOB_ONLYFILE 0x00008000 /**< Match only files. Supported from version 1.6 of UNIXEm. */
#define GLOB_NODOTSDIRS                                                                                                                                        \
  0x00010000 /**< Elide "." and ".." directories from wildcard searches. Supported                                                                             \
 ...
 * @param errfunc A function that is called each time part of the search processing
 * fails
