...
sed_do_list(struct sed_state* st, const char* s, size_t n) {
  ...
  for(i = 0; i < n; i++) {
    ...
    switch(c) {
    case '\\': buf[0] = '\\'; buf[1] = '\\'; plen = 2; break;
    case '\a': buf[0] = '\\'; buf[1] = 'a'; plen = 2; break;
    case '\b': buf[0] = '\\'; buf[1] = 'b'; plen = 2; break;
    case '\f': buf[0] = '\\'; buf[1] = 'f'; plen = 2; break;
    case '\n': buf[0] = '\\'; buf[1] = 'n'; plen = 2; break;
    case '\r': buf[0] = '\\'; buf[1] = 'r'; plen = 2; break;
    case '\t': buf[0] = '\\'; buf[1] = 't'; plen = 2; break;
    case '\v': buf[0] = '\\'; buf[1] = 'v'; plen = 2; break;
